...
# {background-color="black" background-image="img0.png" background-size="1000px"}

# {background-color="black" background-image="mlegp.jpg" background-size="700px"}

# {background-color="black" background-image="legobest.jpg" background-size="700px"}
...
# {background-color="black" background-image="img2.png" background-size="600px"}

# {background-color="black" background-image="img3.png" background-size="600px"}
